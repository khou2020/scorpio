...
#SBATCH -C haswell
#SBATCH -t 00:05:00
#SBATCH --job-name=replay_pnc_414_vars
#SBATCH -o replay_pnc_414_vars_%j.txt
#SBATCH -e replay_pnc_414_vars_%j.err
#SBATCH -L SCRATCH
#SBATCH -A m2956
...
srun -n ${NP} ./pioperf_rearr --pio-niotasks=${NP} --pio-nframes=${NFRAME} --pio-nvars=${NVAR} --pio-decompfiles="decom.dat" --pio-types=pnetcdf --pio-rearrangers=${REARG}
