...
#SBATCH -t 00:03:00
#SBATCH --job-name=replay_adios_knl_414_vars
#SBATCH -o replay_adios_knl_414_vars_%j.txt
#SBATCH -e replay_adios_knl_414_vars_%j.err
#SBATCH --exclusive
#SBATCH -L SCRATCH
#SBATCH -A m844
...
OUTDIR=/global/cscratch1/sd/khl7265/FS_64_1M/scorpio/knl/adios2
...
srun -n ${NP}  -c 4 --cpu_bind=cores ./pioperf_rearr --pio-niotasks=${NP} --pio-nframes=${NFRAME} --pio-nvars=${NVAR} --pio-decompfiles="decom.dat" --pio-types=adios --pio-rearrangers=${REARG}
